...
const ProductGroupController = require('@src/controllers/ProductGroupController')
const ManufacturerController = require('@src/controllers/ManufacturerController')
...
router.get('/group/get-product/:groupId', catchErrorsAsync(ProductGroupController.getProductByGroup))
