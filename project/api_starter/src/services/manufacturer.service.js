...
export const find = async (filter = {}, projection = {}, options = {}) => {
  return Manufacturer.find(filter, projection, options)
}

export const paginate = async (query = {}, options = {}) => {
  return Manufacturer.paginate(query, options)
}

export const getById = async (id, projection = {}, options = {}) => {
  return Manufacturer.findById(id, projection, options)
}

export const findOne = async (query = {}, projection = {}, options = {}) => {
  return Manufacturer.findOne(query, projection, options)
}
...
export const findByIdAndUpdate = async (id, data = {}, options = {}) => {
  return Manufacturer.findByIdAndUpdate(id, data, options)
}

export const _delete = async (id) => {
  return Manufacturer.findByIdAndRemove(id)
}
